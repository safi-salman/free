    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="card">
        ...
        <div class="mb-4">
          ...
          <input id="name" type="text" class="w-full p-2 border rounded" placeholder="Safi Salman" value="${state.userName}">
          <div id="name-error" class="text-red-500 text-sm mt-1"></div>
        </div>
        
        <div class="mb-4">
          <label for="email" class="block mb-1 font-medium">Email</label>
          <input id="email" type="email" class="w-full p-2 border rounded" placeholder="salman@example.com" value="${state.userEmail}">
